...
SWIGINTERN PyObject *_wrap_Test_x_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "Test_x_set", 2, 2, swig_obj)) SWIG_fail;
  ...
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "Test_x_set" "', argument " "2"" of type '" "int""'");
  } 
...
SWIGINTERN PyObject *_wrap_Test_foo(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_Test, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Test_foo" "', argument " "1"" of type '" "Test *""'"); 
  }
  arg1 = reinterpret_cast< Test * >(argp1);
  (arg1)->foo();
  resultobj = SWIG_Py_Void();
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "Test_x_set", _wrap_Test_x_set, METH_VARARGS, NULL},
	 { "Test_x_get", _wrap_Test_x_get, METH_O, NULL},
	 { "Test_foo", _wrap_Test_foo, METH_O, NULL},
